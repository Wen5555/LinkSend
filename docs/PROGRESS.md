...
- Windows 125% DPI 原生小窗请求 960×640 后受最小高度约束为 960×700，继续请求 600×400 时钳制为 900×700，对应 720×560 逻辑最小值乘 1.25；进程 exit 0。production WebView2 禁止环境变量 CDP 且 UIA 不暴露 DOM，因此该结果不冒充 150% 内容、中文长名、深色或键盘通过。
