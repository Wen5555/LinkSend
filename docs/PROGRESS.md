...
- Windows 准确 portable 包在独立 profile 首次与二次启动均创建 1120×760 原生窗口、1105×721 客户区，当前物理显示为 120 DPI（125%），进程 6 秒后存活。关闭主窗 2 秒后窗口和进程仍存在，两轮均由验收脚本强制清理；没有把强制结束写成优雅退出。150% DPI、键盘/深色和完整关闭生命周期待补。
