...
xcrun swiftc -swift-version 5 -target arm64-apple-macos13.0 -framework Cocoa -framework CryptoKit Host.swift -o "$app/Contents/MacOS/LinkSendE0Share"
xcrun swiftc -swift-version 5 -target arm64-apple-macos13.0 -framework Cocoa -framework UniformTypeIdentifiers -framework CryptoKit -application-extension -parse-as-library -Xlinker -e -Xlinker _NSExtensionMain ShareViewController.swift -o "$ext/Contents/MacOS/LinkSendE0Extension"
